...
#'
#' @description
#' The MA(4) that is used as the base coefficients for the variation is `(-.3,-.6,-.3,.6)`. This is based on the MA(4) used in \insertRef{granados-garcia_brain_2022}{HBEST}.
#' 
#' @details
